...
public func mlx_put_image_to_window_scale_swift(_ mlxptr:UnsafeRawPointer, _ winptr:UnsafeRawPointer, _ imgptr:UnsafeRawPointer, _ x:Int32, _ y:Int32, _ dest_w:Int32, _ dest_h:Int32) -> Int32
{
	let win:MlxWin = _mlx_bridge(ptr:winptr)
	let img:MlxImg = _mlx_bridge(ptr:imgptr)
	win.putImageScale(image:img, x:x, y:y, dw:dest_w, dh:dest_h)
	return Int32(0)
}
